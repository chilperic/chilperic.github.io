...
\newcommand{\paper}[1]{\small #1\par\vspace{1.1pt}}
...
\centering
\fcolorbox{Copper}{white}{\includegraphics[width=2.35cm,height=2.66cm,keepaspectratio]{profile_picture.png}}
\end{minipage}
}}
...
\projectline{FokoLab}{Browser-native scientific modelling platform for user-defined models, simulation, fitting, sensitivity, optimisation, population/evolution, diagnostics, visualisation and reproducible export.}{\weblink{Live platform}{https://chilperic.github.io/FokoLab/}}
